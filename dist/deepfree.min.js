/*! DeepFree SDK v1.0.0 | MIT License | deepfree.app */
...
const CARRIER_AMP = 0.03; const CARRIER_AMP_WEBRTC = 0.048; const CARRIER_BINS = 16;
...
this._user = null; this._device = null; this._sessionId = null;
this._audioCtx = null;
...
this._opusMode = false; this._scoreWindow = []; this._listeners = {};
...
this._retryCount++;
const delay = RETRY_BASE_MS * Math.pow(2, this._retryCount - 1); this._log('Recovery attempt ' + this._retryCount + '/' + MAX_RETRIES + ' in ' + delay + 'ms');
...
this._carrierWindow = -1; this._log('WebRTC/Opus mode ' + (enabled ? 'enabled' : 'disabled') + ' manually');
}
};
...
this._opusMode = true;
this._carrierWindow = -1; this._log('Opus degradation detected (avg=' + avg.toFixed(2) + ') — boosting carrier amplitude');
